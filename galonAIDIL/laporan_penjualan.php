...
if (empty($_SESSION['username'])) {
   ...
   if ($jenis == "Semua") {
      $sql = "SELECT p.*, g.*, k.* FROM penjualan p, galon g, konsumen k WHERE p.id_galon = g.id_galon AND k.id = p.id_konsumen AND p.tanggal BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY p.tanggal ASC";
   } else {
      $sql = "SELECT p.*, g.*, k.* FROM penjualan p, galon g, konsumen k WHERE p.id_galon = g.id_galon AND p.id_galon = '$jenis' AND k.id = p.id_konsumen AND p.tanggal BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY p.tanggal ASC";
   }
