...
if (empty($_SESSION['username'])) {
   ...
   $tgl_dari = date_format($td1, "d-m-Y");
   $tgl_sampai = date_format($ts1, "d-m-Y");
   $sql = "";

   $sql = "SELECT p.*, g.*, k.* FROM penjualan p, galon g, konsumen k WHERE p.id_galon = g.id_galon AND k.id = '$konsumen' AND k.id = p.id_konsumen AND p.tanggal BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY p.tanggal ASC";
      ...
      <div class="content-wrapper">
         <div class="row pt-5">
            <div class="col-xl-12 text-center">
               <img src="h2t.png" class="img-fluid" alt="jantan" width="300">
               <p></p>
               <p></p>
