                    ...
                    <div class="card-body">
                        ...
                        <a href="index?page=send_sms&day=<?= $hari ?>" class="btn btn-labeled btn-success mb-2" onclick="return confirm('Kirim SMS untuk semua pelanggan ini?')">
                            <span class="btn-label"><i class="fa fa-check"></i></span>Send SMS</a>
                              ...
                              <!-- coding untuk menu chat whatsapp -->
                            <a href="https://api.whatsapp.com/send?phone=082325201181&text=Halo"class="btn btn-labeled btn-success mb-2" onclick="return confirm('Masuk Whatsapp Untuk Menghubungi Pelanggan ?')">
                            <span class="btn-label"><i class="fa fa-check"></i></span>Whatsapp</a>
