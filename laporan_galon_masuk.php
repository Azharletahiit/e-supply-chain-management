...
if (empty($_SESSION['username'])) {
   ...
   if ($jenis == "Semua") {
      $sql = "SELECT * FROM galon_masuk  WHERE tanggal_masuk BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY tanggal_masuk ASC";
   } else {
      $sql = "SELECT * FROM galon_masuk WHERE jenis = '$jenis' AND tanggal_masuk BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY tanggal_masuk ASC";
   }
